...
namespace Ofgem.Web.BUS.ConsentPortal.WebApp.UnitTests.Pages.Consent
{
    ...
    {
        private ConfirmationModel _systemUnderTest;
        ...
        {
            // Arrange and act
            var action = () => new ConfirmationModel(null!, _mockSessionHelper.Object);
        ...
        {
            // Arrange and act
            var action = () => new ConfirmationModel(_mockOwnerConsentService.Object, null!);
        ...
        public async Task OnGet_ReturnPageResult()
        {
            ...
            _systemUnderTest = new ConfirmationModel(_mockOwnerConsentService.Object, _mockSessionHelper.Object);
