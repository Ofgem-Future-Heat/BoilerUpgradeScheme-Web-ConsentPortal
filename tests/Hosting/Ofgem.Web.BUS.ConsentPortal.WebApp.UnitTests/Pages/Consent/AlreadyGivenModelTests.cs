...
{
    [TestFixture]
    public class AlreadyGivenModelTests
    {
        private AlreadyGivenModel _systemUnderTest;
        ...
        {
            // Arrange and act
            var action = () => new AlreadyGivenModel(null!, _mockSessionHelper.Object);
        ...
        {
            // Arrange and act
            var action = () => new AlreadyGivenModel(_mockOwnerConsentService.Object, null!);
        ...
        public async Task OnGet_ReturnPageResult()
        {
            ...
            _systemUnderTest = new AlreadyGivenModel(_mockOwnerConsentService.Object, _mockSessionHelper.Object);
